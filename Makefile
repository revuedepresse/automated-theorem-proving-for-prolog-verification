...
build-fof-for-each-program:
### Build all .fof files for all logic programs available in ./src
	@. ./bin/build.sh && \
	build_all_fof
...
test:
### Build tests from examples provided in comments before running them
	. ./bin/build.sh && \
	run_tests