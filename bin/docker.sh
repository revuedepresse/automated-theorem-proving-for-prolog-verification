...
# Clear package management system cache
...
# Install tini to keep container running
...
# Run shell (bash) in container in interactive mode with pseudo-TTY as root user
# by using docker compose command and configuration file
# located at in ./etc directory
