...
function run_tests {
  remove_lock_files >> /dev/null 2>&1
	...
	actual=$(VERBOSE=1 combine_results './src/ackermann/ackermann-all.pl' 60 2> /dev/null);expected=33.33333333;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/ackermann/ackermann-all.pl' 10 2> /dev/null);expected=33.33333333;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/ackermann/ackermann-all.pl' 1 2> /dev/null);expected=33.33333333;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/gcd/gcd-all.pl' 60 2> /dev/null);expected=45.45454545;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/gcd/gcd-all.pl' 10 2> /dev/null);expected=45.45454545;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/gcd/gcd-all.pl' 1 2> /dev/null);expected=45.45454545;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/sort/sort-all.pl' 60 2> /dev/null);expected=61.90476190;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/sort/sort-all.pl' 10 2> /dev/null);expected=59.52380952;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/nat/nat-all.pl' 60 2> /dev/null);expected=82.41758241;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/nat/nat-all.pl' 10 2> /dev/null);expected=82.41758241;message='combine_results';assert "${expected}" "${actual}" "${message}"
	actual=$(VERBOSE=1 combine_results './src/taut/taut-all.pl' 1 2> /dev/null);expected=69.76744186;message='combine_results';assert "${expected}" "${actual}" "${message}"
